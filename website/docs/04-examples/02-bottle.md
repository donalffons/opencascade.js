...
Head over to the [OpenCascade tutorial for this example](https://dev.opencascade.org/doc/overview/html/occt__tutorial.html) for a detailed explanation of all the steps involved. 
